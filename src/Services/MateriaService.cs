...
public class MateriaService
{
    ...
    public delegate void MateriaCriadaEventHandler(object source, EventArgs e);
    ...
    public void CriarMateria(List<Professor> professoresPossiveis)
    {
        ...
        OnCriouMateria(new EventArgs());

    }

    public event MateriaCriadaEventHandler? CriouMateria;


    public virtual void OnCriouMateria(EventArgs e)
    {
        if (CriouMateria != null)
            CriouMateria(this,e);
    }
